...
<div class="main">
  ...
  <p class="description">ООО &laquo;Аквафор Инжиниринг&raquo;
    <span class="description__insert">
      является представительством компании Аквафор в Москве и Московской области.
      На сегодняшний день АКВАФОР - это крупнейшее в Европе производство сорбентов
      и фильтров для воды. Занимает около трети российского рынка по системам водоочистки
      и работает с 1992 года. Компания располагает собственным исследовательским центром с
      химическим, микробиологическим, конструкторским и технологическим отделами.
    </span>
  </p>
  <p class="description">
    <span class="description__insert">
