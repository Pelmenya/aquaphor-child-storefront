...
<svg
  <?php
    if (!is_page('water-analysis')) echo 'onClick="window.history.back()"';
  ?>
  class ="header__prev-page-button <?php if (is_page('water-analysis')) echo 'smart-phone-is-closed' ?> " width="11" height="18" viewBox="0 0 11 18">
  <defs>
