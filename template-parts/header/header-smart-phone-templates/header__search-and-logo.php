...
<a class="header__logo-link" href="<?php echo SITE_URL?>?intro=false">
...
<a href="<?php echo SITE_URL?>cart">
  <svg class="header__cart-button" width="17" height="17" viewBox="0 0 17 17">
    <path fill="#28293C" d="M6.333 4h3.334c.184 0 .333.223.333.5s-.149.5-.333.5H6.333C6.15 5 6 4.777 6 4.5s.149-.5.333-.5zm-3.85 0c-.584 0-.994.478-1.059.984L.007 15.93C-.07 16.538.482 17 1.067 17h14.866c.584 0 1.138-.462 1.06-1.07L15.576 4.984C15.51 4.477 15.1 4 14.516 4h-1.412c-.465 0-.468.684 0 .684h1.412c.2 0 .326.14.357.385l1.417 10.948c.018.143-.156.299-.357.299H1.067c-.2 0-.375-.155-.357-.3L2.127 5.07c.031-.247.155-.385.357-.385h1.412c.462 0 .479-.684 0-.684H2.484zM8.5 0C6.57 0 5 1.496 5 3.334v2.334c0 .435.7.45.7 0V3.334C5.7 1.857 6.95.667 8.5.667c1.55 0 2.8 1.19 2.8 2.667v2.334c0 .448.7.438.7 0V3.334C12 1.496 10.43 0 8.5 0z"/>
  </svg>
</a>
<svg class="header__cross" width="18" height="18" viewBox="0 0 18 18">
