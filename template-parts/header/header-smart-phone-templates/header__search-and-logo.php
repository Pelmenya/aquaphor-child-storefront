...
<?php
  $fill_color = 'header__logo-blue';
  if (is_product()){
    $fill_color = 'header__logo-white';
   }
?>
...
<a href="<?php echo SITE_URL?>cart">
  <svg class="header__cart-button <?php if (is_product()) echo 'header__cart-button_white';?>" width="23" height="22" viewBox="0 0 23 22">
    <g fill="none" fill-rule="evenodd" stroke-linecap="round" stroke-linejoin="round">
        <g stroke-width="2">
            <g>
                <g>
                    <path d="M5.708 18.232c.444 0 .805.36.805.805 0 .444-.361.804-.805.804-.445 0-.805-.36-.805-.804 0-.444.36-.805.805-.805zM17.552 18.232c.445 0 .806.36.806.805 0 .444-.361.804-.806.804-.444 0-.805-.36-.805-.804 0-.444.361-.805.805-.805zM.79.79l2.189.378 1.014 12.077c.082.984.904 1.74 1.891 1.74H17.37c.944 0 1.744-.692 1.88-1.627l.998-6.903c.123-.852-.537-1.614-1.397-1.614H3.331M12.764 8.732L15.683 8.732" transform="translate(-314 -22) translate(315 23)"/>
                </g>
            </g>
        </g>
    </g>
